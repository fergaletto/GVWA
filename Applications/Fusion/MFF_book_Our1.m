...
I1 = im2double(imread('results/MFF_book_I1.png'));
I2 = im2double(imread('results/MFF_book_I2.png'));
...
% 
% %% Save result
imwrite(I1, 'results/MFF_book_I1.png');
imwrite(I2, 'results/MFF_book_I2.png');
imwrite(F, 'results/MFF_book_ours.png');

% %% Evaluate
addpath('evaluation/');
A = imread('results/MFF_book_I1.png');
B=imread( 'results/MFF_book_I2.png');
F=imread('results/MFF_book_ours.png');
%%


Eval(3,:) = table( 0.61332,	0.87643,	0.90782,	0.74186,	0.51189); %EGG values. 
